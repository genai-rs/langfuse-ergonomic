...
## [0.6.4](https://github.com/genai-rs/langfuse-ergonomic/compare/v0.6.3...v0.6.4) - 2026-09-24

### Fixed

- *(deps)* update rustls for RUSTSEC-2026-0285
- *(deps)* update locked h2 to patched 0.4.16
- send generation token usage to Langfuse
...
- verify generation usage against live Langfuse
- *(deps)* Update Rust crate thiserror to ^2.0.20
...
- *(deps)* Update Rust crate thiserror to ^2.0.18
- *(deps)* Update rust patch updates
